...
const projectImage  document.querySelector('.project-imag');
...
const nameInput = documentgetElementById('name');
...
if (JSON.parse(localStorage.getItem('name')) !== null) {
  ...
  emailInput.setAttribue('value', localData.email);
